...
class SDNetTrainer(BaseTrainer):
    ...
    def official(self, model_path, test_data):
        ...
        print("PREV_ANS_INDICATOR: ", self.opt.get("PREV_ANS_INDICATOR", 0))
        print("PREV_ANS_MASK: ", self.opt.get("PREV_ANS_MASK", 0))
    ...
    def update(self, batch):
        ...
        query_char, query_char_mask, query_bert, query_bert_mask, query_bert_offsets, ground_truth, context_str, context_words, _, _, _, _, x_prev_ans_mask = batch
