...
def main():
    ...
    if args.resume:
        batches = BatchGen_QuAC(dev, batch_size=args.batch_size, evaluation=True, gpu=args.cuda, dialog_ctx=args.explicit_dialog_ctx, use_dialog_act=args.use_dialog_act, prob_shuffle=args.prob_shuffle)
    ...
    for epoch in range(epoch_0, epoch_0 + args.epoches):
        ...
        # train
        batches = BatchGen_QuAC(train, batch_size=args.batch_size, gpu=args.cuda, dialog_ctx=args.explicit_dialog_ctx, use_dialog_act=args.use_dialog_act, precompute_elmo=args.elmo_batch_size // args.batch_size, prob_shuffle=args.prob_shuffle)
        start = datetime.now()
