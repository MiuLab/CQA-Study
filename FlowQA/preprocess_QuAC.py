...
parser.add_argument('--train_file', type=str, default='QuAC_data/train.json')
parser.add_argument('--dev_file', type=str, default='QuAC_data/dev.json')
parser.add_argument('--output_dir', type=str, default='QuAC_data/')
