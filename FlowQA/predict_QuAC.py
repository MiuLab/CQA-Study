...
parser.add_argument('--explicit_dialog_ctx', type=int, default=None)
...
def main():
    ...
    if args.explicit_dialog_ctx is not None:
        if opt['explicit_dialog_ctx'] == 0:
            opt['remove_dim_indicator'] = True
        opt['explicit_dialog_ctx'] = args.explicit_dialog_ctx
